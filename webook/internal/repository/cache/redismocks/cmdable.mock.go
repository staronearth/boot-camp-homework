...
func (m *MockCmdable) TFCall(ctx context.Context, libName string, funcName string, numKeys int) *redis.Cmd {
	//TODO implement me
	panic("implement me")
}

func (m *MockCmdable) TFCallArgs(ctx context.Context, libName string, funcName string, numKeys int, options *redis.TFCallOptions) *redis.Cmd {
	//TODO implement me
	panic("implement me")
}

func (m *MockCmdable) TFCallASYNC(ctx context.Context, libName string, funcName string, numKeys int) *redis.Cmd {
	//TODO implement me
	panic("implement me")
}

func (m *MockCmdable) TFCallASYNCArgs(ctx context.Context, libName string, funcName string, numKeys int, options *redis.TFCallOptions) *redis.Cmd {
	//TODO implement me
	panic("implement me")
}
...
func (m *MockCmdable) CFReserveExpansion(ctx context.Context, key string, capacity int64, expansion int64) *redis.StatusCmd {
	//TODO implement me
	panic("implement me")
}

func (m *MockCmdable) CFReserveBucketSize(ctx context.Context, key string, capacity int64, bucketsize int64) *redis.StatusCmd {
	//TODO implement me
	panic("implement me")
}

func (m *MockCmdable) CFReserveMaxIterations(ctx context.Context, key string, capacity int64, maxiterations int64) *redis.StatusCmd {
	//TODO implement me
	panic("implement me")
}
...
func (m *MockCmdable) TopKReserveWithOptions(ctx context.Context, key string, k int64, width, depth int64, decay float64) *redis.StatusCmd {
	//TODO implement me
	panic("implement me")
}
